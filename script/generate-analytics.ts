...
async function main(){
 ...
 const [visitorBatch]=await analyticsDataClient.batchRunReports({property:`properties/${propertyId}`,requests:[
  {dateRanges:[{startDate:"30daysAgo",endDate:"today"}],dimensions:[{name:"city"},{name:"region"},{name:"country"}],metrics:[{name:"totalUsers"},{name:"sessions"}],orderBys:[{metric:{metricName:"totalUsers"},desc:true}],limit:20},
  ...
  {dateRanges:[{startDate:"30daysAgo",endDate:"today"}],dimensions:[{name:"date"},{name:"dateHourMinute"},{name:"city"},{name:"region"},{name:"country"},{name:"deviceCategory"},{name:"browser"},{name:"operatingSystem"},{name:"landingPage"}],metrics:[{name:"sessions"},{name:"screenPageViews"},{name:"averageSessionDuration"},{name:"activeUsers"}],orderBys:[{dimension:{dimensionName:"dateHourMinute"},desc:true},{metric:{metricName:"sessions"},desc:true}],limit:250},
 ]});
